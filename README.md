...
Targets:
  ...
  packages/leetcode               Run leetcode/parse
  packages/leetcode/download      Download last 20 submissions to ./leetcode/submissions.json
  packages/leetcode/generate      Generate files in ./leetcode/submissions/ from ./leetcode/submissions.json
  packages/leetcode/update        Download new submissions, create MR for them, merge the MR
  packages/leetcode/format        Run leetcode/format-black and leetcode/format-gofmt
  packages/leetcode/format-black  Format submissions using black
  packages/leetcode/format-gofmt  Format submissions using gofmt
  ...
  make/get-packages               Search for directories containing Makefiles
  make/update-package-list        Update PACKAGES line in ./Makefile
